...
export const metadata: Metadata = {
  title: "Sık Sorulan Sorular | EscortVIP SSS Rehberi",
  description: "Ödeme süreçleri, gizlilik, rezervasyon iptali ve doğrulama süreçleri hakkında sıkça sorulan soruların gerçek ve net cevapları.",
};
    ...
    items: [
      {
        ...
        a: "Hayır. EscortVIP 'Zero-Log' politikası uygular. İletişim geçmişiniz, IP adresiniz veya rezervasyon detaylarınız sunucularımızda asla saklanmaz. Tüm görüşmeler otomatik imha standartlarına tabidir."
      },
      {
        q: "Panik Butonu nedir ne işe yarar?",
        a: "Sayfanın sol alt köşesindeki kalkan simgesi, acil durumlarda ekranınızı anında güvenli bir içeriğe (hava durumu vb.) yönlendirmek için tasarlanmıştır. Çevresel gizliliğinizi anında korur."
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        a: "Sistemimizdeki profillerin %100'ü 'Doğrulama Standartları'ndan geçer. Görseller günceldir ve fiziksel özellikler teyit edilmiştir. Sahte profil (fake) saptandığı an ilgili hesap ağdan süresiz ihraç edilir."
      },
      {
      ...
      <main className="max-w-4xl mx-auto py-32 px-6 md:px-12">
        <section className="text-center mb-24">
          ...
          <p className="text-zinc-500 text-lg md:text-xl font-medium max-w-2xl mx-auto leading-relaxed">
            EscortVIP deneyiminizi kusursuz hale getirmek için bilmeniz gereken her şey burada yer alıyor.
          </p>
        </section>
        ...
        <section className="mt-40 bg-zinc-950 border border-zinc-900 rounded-[3rem] p-12 text-center group hover:border-rose-600/30 transition-all duration-700">
           ...
           <a href="/iletisim" className="inline-block bg-white text-black px-10 py-4 rounded-full font-black uppercase tracking-widest text-[10px] hover:bg-rose-600 hover:text-white transition-all">
            İletişime Geç
           </a>
        </section>
      </main>
