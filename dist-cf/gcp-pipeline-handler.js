...
exports.hydraTelemetryHandler = hydraTelemetryHandler;
 ...
 */
async function hydraTelemetryHandler(event, context) {
    try {
        ...
        let authClient;
        const bqAuth = new googleapis_1.google.auth.GoogleAuth({
        ...
        if (fs.existsSync(keyPath)) {
            ...
            const gscAuth = new googleapis_1.google.auth.GoogleAuth({
                keyFile: keyPath,
        ...
        const sc = googleapis_1.google.searchconsole({ version: 'v1', auth: authClient });
        ...
        const bigquery = googleapis_1.google.bigquery({ version: 'v2', auth: bqAuthClient });
        const row = {
