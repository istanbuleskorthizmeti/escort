      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-center">
        ...
        <Link href="/" className="group flex flex-col items-center text-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-3xl md:text-5xl font-black italic tracking-tighter text-(--primary-color) uppercase leading-none group-hover:scale-105 transition-transform duration-500">{restWords}</span>
          </div>
          <div className="text-[10px] font-black tracking-[0.5em] text-zinc-500 uppercase mt-3 group-hover:text-(--primary-color)/70 transition-colors">{slogan}</div>
        </Link>
