...
async function runTier2Bombardment() {
    ...
    const masterTemplate = await generateTemplateContent({ city: 'İstanbul', host: 'istanbulescdrkcn.com' });
    ...
    for (let i = 0; i < targetUrls.length; i++) {
        ...
        try {
            ...
            // Sistem hardcoded olarak istanbulescdrkcn.com'a link basar.
            // Biz bu linki Google Sites URL'miz ile degistirerek PBN gucunu aktariyoruz.
            const swapUrl = (str: string) => str.replace(/https:\/\/istanbulescdrkcn\.com/g, targetUrl);
            ...
            await HydraOrchestrator.executeSiege({
                ...
                host: 'istanbulescdrkcn.com', // Keeps AI persona intact
