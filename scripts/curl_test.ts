...
async function run() {
  try {
    ...
    const result = await ssh.execCommand('curl -s -L -H "Host: vipescorthizmeti.com" -H "User-Agent: Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)" http://127.0.0.1:3001');
