...
Subdomainlerin WhatsApp, Telegram ve iMessage üzerinden paylaşımlarında 'boş veya kırık' gözüken önizlemeler onarıldı. Statik build esnasında patlayan host değişkeni default bir fallback ('istanbulescort.blog') atanarak çözüldü.
...
istanbulescort.blog ve diğer money sitelerde Gemini API üzerinden üretilen 2500+ kelimelik devasa MDX makalesinin yerine yanlışlıkla 3 satırlık Parazit SEO (Syndication) içeriğinin gösterilmesine sebep olan parser bug'ı tespit edildi ve 'ai-seo.ts' kökten düzeltildi. Artık siteler devasa, agresif, uzun içeriklerle dolacak'

✅ **4. E-Ticaret (Shop/Eczane) Cloaker Revizyonu:**
shop.istanbulescort.blog gibi satış sitelerinde yer alan standart metinler, talep üzerine 'Agresif Ürün Tanıtımı ve FOMO (Kaçırma Korkusu)' yaratacak şekilde kışkırtıcı bir satış diline çevrildi. Ürün başlıkları, kullanıcı yorumları ve butonlar maksimize edildi.
