...
async function runTier2Bombardment() {
    ...
    const masterTemplate = await generateTemplateContent({ city: 'İstanbul', host: 'istanbulescort.blog' });
    ...
    for (let i = 0; i < targetUrls.length; i++) {
        ...
        try {
            ...
            // Sistem hardcoded olarak istanbulescort.blog'a link basar.
            ...
            await HydraOrchestrator.executeSiege({
                ...
                host: 'istanbulescort.blog', // Keeps AI persona intact
