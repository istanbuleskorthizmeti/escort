...
async function run() {
  try {
    ...
    // 1. Sync globals.css to the server
    console.log(' • Syncing app/globals.css to the server...');
    await ssh.putFile('c:\\Users\\onurk\\esc\\app\\globals.css', '/var/www/escortvip/app/globals.css');
    console.log('   ✔ Synced.');
