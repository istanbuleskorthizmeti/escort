...
export const DOMAIN_MATRIX: DomainConfig[] = [
  ...
  { host: 'vipescorthizmeti.com', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['vip', 'premium', 'luxury', 'main'], theme: 'luxury', serverGroup: 'MAIN_SERVER' },
  ...
  { host: 'bagcilarescort.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'bagcilar', 'young'], targetCity: 'istanbul', targetDistrict: 'bagcilar', theme: 'dark', serverGroup: 'MAIN_SERVER' },
  { host: 'esenyurtescort.blog', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'esenyurt', 'blog'], targetCity: 'istanbul', targetDistrict: 'esenyurt', theme: 'gold', serverGroup: 'MAIN_SERVER' },
  { host: 'esenyurtescorthizmeti.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'esenyurt', 'service'], targetCity: 'istanbul', targetDistrict: 'esenyurt', theme: 'rose', serverGroup: 'MAIN_SERVER' },
  { host: 'beylikduzuescortlistesi.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'beylikduzu', 'list'], targetCity: 'istanbul', targetDistrict: 'beylikduzu', theme: 'emerald', serverGroup: 'MAIN_SERVER' },
  { host: 'besiktasescorthizmeti.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'besiktas', 'premium'], targetCity: 'istanbul', targetDistrict: 'besiktas', theme: 'luxury', serverGroup: 'MAIN_SERVER' },
  { host: 'besiktasescort.fun', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'besiktas', 'fun'], targetCity: 'istanbul', targetDistrict: 'besiktas', theme: 'gold', serverGroup: 'MAIN_SERVER' },
  { host: 'besiktasescort.blog', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'besiktas', 'blog'], targetCity: 'istanbul', targetDistrict: 'besiktas', theme: 'rose', serverGroup: 'MAIN_SERVER' },
  { host: 'taksimescorthizmeti.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'taksim', 'beyoglu'], targetCity: 'istanbul', targetDistrict: 'beyoglu', theme: 'dark', serverGroup: 'MAIN_SERVER' },
  { host: 'sefakoyescorthizmeti.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'sefakoy', 'kucukcekmece'], targetCity: 'istanbul', targetDistrict: 'sefakoy', theme: 'emerald', serverGroup: 'MAIN_SERVER' },
  { host: 'kucukcekmecescort.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'kucukcekmece', 'shop'], targetCity: 'istanbul', targetDistrict: 'kucukcekmece', theme: 'gold', serverGroup: 'MAIN_SERVER' },
  { host: 'sisliescort.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'sisli', 'luxury'], targetCity: 'istanbul', targetDistrict: 'sisli', theme: 'luxury', serverGroup: 'MAIN_SERVER' },
  { host: 'avrupayakasiescort.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'avrupa-yakasi', 'general'], targetCity: 'istanbul', theme: 'rose', serverGroup: 'MAIN_SERVER' },
  { host: 'istanbulescorthizmeti.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'istanbul', 'general'], targetCity: 'istanbul', theme: 'gold', serverGroup: 'MAIN_SERVER' },
  { host: 'kadikoyescort.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'kadikoy', 'anadolu-yakasi'], targetCity: 'istanbul', targetDistrict: 'kadikoy', theme: 'emerald', serverGroup: 'MAIN_SERVER' },
  { host: 'pendikescorthizmeti.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'pendik', 'anadolu-yakasi'], targetCity: 'istanbul', targetDistrict: 'pendik', theme: 'luxury', serverGroup: 'MAIN_SERVER' },
  { host: 'bucaescorthizmeti.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'buca', 'izmir'], targetCity: 'izmir', targetDistrict: 'buca', theme: 'gold', serverGroup: 'MAIN_SERVER' },
  { host: 'izmitescorthizmeti.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'izmit', 'kocaeli'], targetCity: 'kocaeli', targetDistrict: 'izmit', theme: 'emerald', serverGroup: 'MAIN_SERVER' },

  // --- NEW SATELLITE DOMAINS ---
  { host: 'sariyerdrkcnay.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'sariyer', 'drkcnay'], targetCity: 'istanbul', targetDistrict: 'sariyer', theme: 'luxury', serverGroup: 'MAIN_SERVER' },
  { host: 'leventdrkcnay.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'levent', 'drkcnay'], targetCity: 'istanbul', targetDistrict: 'besiktas', theme: 'gold', serverGroup: 'MAIN_SERVER' },
  { host: 'istanbuldrkcnay.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'istanbul', 'drkcnay'], targetCity: 'istanbul', theme: 'rose', serverGroup: 'MAIN_SERVER' },
  { host: 'istanbulescortkaporasiz.shop', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'istanbul', 'kaporasiz'], targetCity: 'istanbul', theme: 'emerald', serverGroup: 'MAIN_SERVER' },
  { host: 'shopistanbulescortkaporasiz.site', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['local', 'istanbul', 'kaporasiz', 'shop'], targetCity: 'istanbul', theme: 'dark', serverGroup: 'MAIN_SERVER' },
  ...
  { host: 'escortcoin.space', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['crypto', 'escort', 'token'], theme: 'gold', serverGroup: 'MAIN_SERVER' },
