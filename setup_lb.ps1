...
# Add Endpoints
gcloud compute network-endpoint-groups update hydra-backend-neg --add-endpoint="ip=213.232.235.181,port=80" --add-endpoint="ip=187.77.111.203,port=80" --add-endpoint="ip=45.93.137.164,port=80" --global
