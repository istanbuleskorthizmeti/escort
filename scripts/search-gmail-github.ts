...
async function run() {
  ...
  try {
    console.log("Found Gmail tab. Searching for 'github'...");
    
    // Go to search in Gmail
    await gmailPage.goto("https://mail.google.com/mail/u/0/#search/github", { waitUntil: 'networkidle' });
    ...
    console.log("GitHub Search Results in Gmail:", emailList);
