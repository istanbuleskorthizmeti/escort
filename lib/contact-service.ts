...
const DEFAULT_WHATSAPP = process.env.NEXT_PUBLIC_WHATSAPP || "905520949245";
const DEFAULT_SHORTLINK = process.env.NEXT_PUBLIC_SHORTLINK || "https://vipescorthizmeti.com/wa";
