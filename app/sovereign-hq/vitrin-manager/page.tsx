    ...
    try {
      await fetch("/api/admin/ads", {
        ...
        body: JSON.stringify({
          name,
          age: parseInt(age),
          phone: phone || "905016355053", // Fallback to site default
          image,
          tier,
          features: [tier]
        })
    ...
    <div className="min-h-screen bg-black text-zinc-300 font-sans p-4 md:p-8">
      <div className="max-w-6xl mx-auto flex flex-col gap-8">
        ...
        <header className="flex justify-between items-end border-b border-zinc-900 pb-4">
          <div>
            <Link href="/sovereign-hq" className="text-zinc-500 hover:text-white text-xs uppercase tracking-widest mb-4 block">
              ← SİSTEME GERİ DÖN
            </Link>
