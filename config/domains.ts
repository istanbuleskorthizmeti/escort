...
export const DOMAIN_MATRIX: DomainConfig[] = [
  ...
  { host: 'vipescorthizmeti.com', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['vip', 'premium', 'com'], theme: 'luxury', serverGroup: 'MAIN_SERVER' },
  { host: 'istanbulescdrkcn.com', role: 'MONEY_SITE', category: 'MONEY_SITE', tags: ['vip', 'luxury', 'com'], theme: 'gold', serverGroup: 'MAIN_SERVER' },
