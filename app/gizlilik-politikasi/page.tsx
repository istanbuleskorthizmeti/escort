...
export const metadata: Metadata = {
  title: "Gizlilik Politikası | Elit Güvenlik Protokolü",
  description: "istanbulescort.blog gizlilik politikası, veri koruma standartları ve kullanıcı güvenlik taahhütleri.",
};
    ...
    <div className="min-h-screen bg-black text-zinc-300 font-sans selection:bg-rose-600 selection:text-white antialiased">
      ...
      <main className="max-w-4xl mx-auto py-32 px-6">
        <header className="mb-24 text-center">
          ...
          <p className="text-rose-600/60 text-xs font-black tracking-[0.2em] uppercase italic">
            GDPR & AVG // Elit Privacy Standard v3.1
          </p>
        </header>
        ...
        <section className="space-y-16 leading-relaxed">
          <div className="bg-zinc-950/50 backdrop-blur-3xl border border-zinc-900 rounded-[3rem] p-12 hover:border-rose-600/30 transition-all">
            ...
            <p className="mb-6">
              İçeriklerimiz ve siber altyapımız Hollanda merkezli olup, tüm veri işleme faaliyetlerinde <b>Algemene Verordening Gegevensbescherming (AVG)</b> standartlarını sarsılmaz bir şekilde uygular. Gizliliğiniz, Amsterdam mahkemelerinin yetki alanı ve Hollanda siber güvenlik kanunları ile korunmaktadır.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="border border-zinc-900 rounded-[2rem] p-8 hover:bg-zinc-950 transition-colors">
              ...
              <p className="text-sm opacity-60">
                Platformumuz, "Privacy by Design" ilkesine göre inşa edilmiştir. Gereksiz hiçbir veri toplanmaz, IP adresleri maskelenir ve oturumlar kapandığında tüm geçici izler imha standardıyla silinir.
              </p>
            </div>
            <div className="border border-zinc-900 rounded-[2rem] p-8 hover:bg-zinc-950 transition-colors">
          ...
          <div className="space-y-8">
            <h2 className="text-3xl font-black italic uppercase text-white mb-6">Elit Sektör Güvenceleri</h2>
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                "Gizli İletişim Kanalları Güvenliği"
              ].map((item, idx) => (
      ...
      <footer className="py-20 border-t border-zinc-900 mt-40 text-center opacity-30">
        <div className="text-[9px] font-black tracking-[1em] text-zinc-600 uppercase italic">
          AMSTERDAM DATA PROTECTION COUNCIL // 2026
        </div>
      </footer>
    </div>
  );
