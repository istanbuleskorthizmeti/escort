    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-[#ff0000] selection:text-white pb-20 overflow-x-hidden">
      ...
      {!isAgeVerified && (
        <div className="fixed inset-0 z-100 bg-black/90 backdrop-blur-xl flex items-center justify-center p-4">
          <div className="bg-[#0a0a0a] border border-red-900/50 p-8 rounded-3xl max-w-lg w-full text-center shadow-[0_0_100px_rgba(255,0,0,0.1)] relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-red-900 via-red-500 to-red-900"></div>
                ...
                {isBuffering ? (
                  ...
                  <div className="bg-black/90 p-6 md:p-10 rounded-2xl border border-red-900/40 backdrop-blur-xl animate-[scaleIn_0.3s_ease-out] w-full max-w-lg shadow-[0_0_50px_rgba(220,38,38,0.1)]">
                    ...
                    <a 
                      ...
                      className="group flex flex-col items-center justify-center gap-1 bg-linear-to-b from-red-600 to-red-800 hover:from-red-500 hover:to-red-700 text-white font-black py-4 px-6 rounded-xl shadow-[0_0_30px_rgba(255,0,0,0.3)] transition-all hover:scale-105 border border-red-500/50 w-full"
                    >
      ...
      <header className="bg-black/80 backdrop-blur-xl border-b border-white/5 sticky top-0 z-40 shadow-xl">
        <div className="max-w-7xl mx-auto px-4 h-16 md:h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-linear-to-br from-red-500 to-red-800 rounded flex items-center justify-center font-black text-xl shadow-[0_0_15px_rgba(255,0,0,0.5)] border border-red-400/50">
              18+
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 md:py-12">
        <div className="mb-10 md:mb-16 border-l-4 border-red-600 pl-6 bg-linear-to-r from-red-900/10 to-transparent p-4 rounded-r-xl">
